...
<html>
<head>
<title><?PHP echo $rowsettings['ScriptName']?> - Edit Your Personal Profile</title>
...
<script type="text/javascript" src="js/editpersonalprofile.js"></script>
...
?>> Check this box to display your date of birth in profile.
	...
	<br>
			...
			<tr valign="top">
				...
				<?PHP
				$height = '<option value="">Select</option><option value="4ft 5in - 134cm">4ft 5in - 134cm</option><option value="4ft 6in - 137cm">4ft 6in - 137cm</option><option value="4ft 7in - 139cm">4ft 7in - 139cm</option><option value="4ft 8in - 142cm">4ft 8in - 142cm</option><option value="4ft 9in - 144cm">4ft 9in - 144cm</option><option value="4ft 10in - 147cm">4ft 10in - 147cm</option><option value="4ft 11in - 149cm">4ft 11in - 149cm</option><option value="5ft - 152cm">5ft - 152cm</option><option value="5ft 1in - 154cm">5ft 1in - 154cm</option><option value="5ft 2in - 157cm">5ft 2in - 157cm</option><option value="5ft 3in - 160cm">5ft 3in - 160cm</option><option value="5ft 4in - 162cm">5ft 4in - 162cm</option><option value="5ft 5in - 165cm">5ft 5in - 165cm</option><option value="5ft 6in - 167cm">5ft 6in - 167cm</option><option value="5ft 7in - 170cm">5ft 7in - 170cm</option><option value="5ft 8in - 172cm">5ft 8in - 172cm</option><option value="5ft 9in - 175cm">5ft 9in - 175cm</option><option value="5ft 10in - 177cm">5ft 10in - 177cm</option><option value="5ft 11in - 180cm">5ft 11in - 180cm</option><option value="6ft - 182cm">6ft - 182cm</option><option value="6ft 1in - 185cm">6ft 1in - 185cm</option><option value="6ft 2in - 187cm">6ft 2in - 187cm</option><option value="6ft 3in - 190cm">6ft 3in - 190cm</option><option value="6ft 4in - 193cm">6ft 4in - 193cm</option><option value="6ft 5in - 195cm">6ft 5in - 195cm</option><option value="6ft 6in - 198cm">6ft 6in - 198cm</option><option value="6ft 7in - 200cm">6ft 7in - 200cm</option><option value="6ft 8in - 203cm">6ft 8in - 203cm</option><option value="6ft 9in - 205cm">6ft 9in - 205cm</option><option value="6ft 10in - 208cm">6ft 10in - 208cm</option><option value="6ft 11in - 210cm">6ft 11in - 210cm</option><option value="7ft - 213cm">7ft - 213cm</option>';
...
<br>
		...
		if(religion == 1 || religion == 2 || religion == 3 || religion == 4 || religion == 5)
			...
			<tbody><tr>
				<td class="td1" style="cursor: pointer;" onclick="focus_field('religion');" valign="top" height="5"><em>*</em><b>Religion</b></td>
...
<br style="line-height: 7px;">
	...
	<span id="errmsg_std_code" class="error"></span><span id="errmsg_contact_number" class="error"></span>
		...
		<!-- HINT ENDS HERE -->
	<label id="lbl_cnt_display_yes" for="contact_details_dislay_status_show_all" class="swidthtext"><b>Yes</b>, I wish to display the contact details.</label>
				...
				<?PHP
								...
								?>><label id="lbl_cnt_display_no" for="contact_details_dislay_status_none" class="swidthtext"> <b>No</b>, I do not wish to display the contact details.</label><br><span id="errmsg_contact_details_dislay_status" class="error"></span>
...
<input type="hidden" name="continue" value="true">
			<script type="text/javascript">	document.profile.elements['counter1'].value=document.profile.elements['aboutyourself'].value.length;	</script>
