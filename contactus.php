...
<html>
<head>
<title><?PHP echo $rowsettings['ScriptName']?> - Contact Us</title>
...
?>
  ...
  <ul>
    <li>Email: service@famm.3eeweb.com</li>

</ul>

  <form method="post" action="contactus.php" name="frmcontactus" onSubmit="return validateform(this);">
<div class="boldgreen" style="color:#990000 "><b>Contact us by submitting this form:</b></div>
