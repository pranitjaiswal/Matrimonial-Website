...
<html>
<head>
<title><?PHP echo $rowsettings['ScriptName']?> - Login</title>
...
<img src="images/registration-stoppage-model.gif" width="360" style="padding-right:20px"><br>
</div>
...
<td style="" width="190"><input tabindex="15" name="login" class="forminput" id="login" size="25" type="text"><br>
