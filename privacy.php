...
<html>
<head>
<title>Forever Matrimony - World's No. 1 Matrimonial Website</title>
<meta http-equiv="Content-Type" content="text/html">
<link rel="stylesheet" href="css/landing.css" type="text/css">
<link rel="stylesheet" href="css/homepage.css" type="text/css">
<script type="text/javascript" src="js/matrimonials-v10.js"></script>
<script type="text/javascript" src="js/matrimonials-landing1.js"></script>
<script type="text/javascript" src="js/mouseovereffect.js"></script>
<script type="text/javascript" src="js/home-pg.js"></script>
</head>
...
<center>
	...
	<div class="width smallcnt">
		...
		<table cellpadding="0" cellspacing="0" width="760" background="images/searchbg.gif">
...
<td align="left">
			...
			<?PHP
				...
				?>
					...
					<input src="images/go-grn.gif" title="Search" align="top" type="image">
...
<td><img src="images/mid-3-l.gif" alt="" height="138" width="19"></td>
</tr>
...
<span  style="font-size:14px;font-weight:700;color:#FFF;background-color:#a10908;padding-left:70px;padding-right:70px;padding-top:5px;padding-bottom:5px;text-align:center">
		...
		<td width="469"><img src="images/banner.jpg" width="469" height="282px" alt="banner"></td>
...
<div class="left graytxt" style="width: 760px;background-image:url(images/background.jpg); height:5px;"></div>
	...
	<table class="left tleft smallcnt graytxt" cellpadding="0" cellspacing="0" style="padding:10px;border:3px solid #F93;background-color:#FFC">
    <tr>
    <td>
<div align="justify">
<h2 style="text-decoration:underline"> Private Policy</h2>
    <p><b>famm.3eeweb.com</b> is an online matrimonial portal endeavoring constantly to provide you with premium matrimonial services. This privacy statement is common to all the matrimonial sites operated under famm.3eeweb.com Since we are strongly committed to your right to privacy, we have drawn out a privacy statement with regard to the information we collect from you.
      <br>   
      </p>
      ...
      <br>
	  <p><b>How the site uses the information it collects/tracks?</b><br>FAMM collects information from our clients primarily to ensure that we are able to fulfill your requirements and to deliver Personalised experience.
      <br>      
      </p>
	  <p><b>With whom the site shares the information it collects/tracks?</b><br>The information collected from any of our clients is not shared with any individual or organization without the former's approval. famm.3eeweb.com does not sell, rent, or loan any identifiable information at the individual level regarding its customers to any third party. Any information you give us is held with the utmost care and security. We are also bound to cooperate fully should a situation arise where we are required by law or legal process to provide information about a customer.
      <br>      
      </p>
	  ...
	  <p>If you have any questions regarding our Privacy Statement, please write in to <b>service@famm.3eeweb.com</b>
