...
<html>
<head>
<title><?PHP echo $rowsettings['ScriptName']?> - Search Brides and Grooms</title>
...
<script type="text/javascript" src="js/matrimonials-v10.js"></script>
			...
			<div style="width: 760px; background-color: rgb(255, 255, 255);">
...
<div align="center">
<table bgcolor="#ffffff" border="0" cellpadding="0" cellspacing="0" width="760px">
<tbody><tr>
