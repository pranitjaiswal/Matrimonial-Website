...
<html>
<head>
<title><?PHP echo $rowsettings['ScriptName']?> - Edit Partner Profile</title>
...
<script type="text/javascript" src="js/ajax-v2.js"></script>
...
<td align="center" style="padding: 8px;" bgcolor="#fff7e7" valign="top" width="170"><span style="line-height: 5px;"><br></span>
...
<br>
	...
	<tr valign="top">
		...
		<td class="td2">
			...
			<tbody><tr>
				<td>
				<select multiple="multiple" name="community_fromarray[]" size="5" class="formselect" style="width: 175px; height: 45px;">
				<?PHP
				...
				<td>
				<select multiple="multiple" name="communityarray[]" size="5" class="formselect" style="width: 175px; height: 45px;">
				<?PHP
				$selectgrewupin="";
	...
	<tr style="display: none;" id="show_hide_caste" valign="top">
		...
		<td>
			<table border="0" cellpadding="0" cellspacing="0">
			<tbody><tr>
				<td><select multiple="multiple" name="caste_fromarray[]" size="5" class="formselect" style="width: 175px; height: 45px;"></select>
				</td>
				<td align="center" style="padding: 8px;">
				...
				<td>
					<select multiple="multiple" name="castearray[]" size="5" class="formselect" style="width: 175px; height: 45px;"></select>
				</td>
			</tr>
			</tbody></table>
		</td>
	...
	<tr valign="top">
		...
		<td class="td2">
			...
			<tr>
				...
				<td><br>
					<select multiple="multiple" name="education_area_array[]" size="5" class="formselect" style="width: 175px; height: 45px;">
	...
	<tr valign="top">
		...
		<td>
			...
			<tbody><tr>
				...
				<td>
					<select multiple="multiple" name="occupationarray[]" size="5" class="formselect" style="width: 175px; height: 45px;">
					<?PHP
				$selectgrewupin="";
...
?>
	...
	<tr valign="top">
		...
		<td class="td2">
			...
			<tbody><tr>
				<td>
					<select multiple="multiple" name="countryofresidence_fromarray[]" size="0" class="formselect" style="width: 175px; height: 45px; height: 45px">
				...
				<td>
					<select multiple="multiple" name="countryofresidencearray[]" size="5" class="formselect" style="width: 175px; height: 45px;">
...
<script type="text/javascript">
	...
	<tr id="show_hide_state" valign="top">
		...
		<td>
			...
			<tbody><tr>
				<td>
					<span id="statesspan2">
					<select multiple="multiple" name="stateofresidence_fromarray[]" size="5" class="formselect" style="width: 175px; height: 45px;">
					<?PHP
				...
				<td>
				<select multiple="multiple" name="stateofresidencearray[]" size="5" class="formselect" style="width: 175px; height: 45px;">
				<?PHP
				$selectgrewupin="";
	...
	<tr valign="top">
		...
		<td>
			...
			<tbody><tr>
				<td>
					<select multiple="multiple" name="residencystatus_fromarray[]" size="5" class="formselect" style="width: 175px; height: 45px;"><option value="Citizen">Citizen</option><option value="Permanent Resident">Permanent Resident</option><option value="Student Visa">Student Visa</option><option value="Temporary Visa">Temporary Visa</option><option value="Work Permit">Work Permit</option></select>
				</td>
				<td align="center" style="padding: 8px;">
				...
				<td>
					<select multiple="multiple" name="residencystatusarray[]" size="5" class="formselect" style="width: 175px; height: 45px;">
					<?PHP
				$selectgrewupin="";
