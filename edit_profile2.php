...
<html>
<head>
<title><?PHP echo $rowsettings['ScriptName']?> - Edit Your Profile</title>
...
<script type="text/javascript" src="js/ajax-v2-inc-mod.js"></script>
<script type="text/javascript" src="js/editprofile2.js"></script>
</head>
...
<tr>
	...
	<td>
		<select multiple="multiple" size="6" name="grew_up_inarray[]" id="grew_up_inarray" class="field_filled" onfocus="toggleHint('show', 'grew_up_inarray')" onblur="toggleHint('hide', 'grew_up_inarray'); checkStyleSelect(this, 'field', 'field_filled');" style="width: 175px; height: 45px;"><option value="" selected="selected">Select</option>
...
<br>
		...
		<script type="text/javascript">	document.profile.elements['counter2'].value=document.profile.elements['aboutfamily'].value.length;
		</script>
