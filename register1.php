...
<center>
  ...
  <div style="width: 782px; background-color: rgb(255, 255, 255);">
    <div style="border-top: 1px solid rgb(143, 167, 191); border-left: 1px solid rgb(143, 167, 191); border-right: 1px solid rgb(143, 167, 191);">
      <!-- logo + banner space -->
      <div style="padding: 2px 0pt 2px 0px;">
        <div style="padding: 4px 0pt 4px 10px; float: left; text-align: left;">
      ...
      <div>
        <div style="border-top: 2px solid rgb(143, 167, 191); border-bottom: 2px solid #000000; background-color: #000000;">
          <div style="margin: 1px 0pt 1px 0px; padding: 3px 0pt 3px 0px; background-color: #990000;" class="mediumwhitebold"> </div>
        </div>
      </div>
  ...
  <div style="width: 782px;">
    <div class="mediumblack" style="border-style: solid; border-color: rgb(143, 167, 191); border-width: 0px 1px 1px; background: rgb(255, 255, 255) none repeat scroll 0%; -moz-background-clip: initial; -moz-background-origin: initial; -moz-background-inline-policy: initial;">
      <div style="width: 760px;">
        ...
        <!-- YAHOO CODE -->
        <!-- YAHOO CODE-->
        <form method="post" action="register1.php" name="frm_registration" id="frm_registration" autocomplete="off" onSubmit="return validateform(this);">
                        ...
                        <table class="tblreg" border="0" cellpadding="5" cellspacing="4" width="400">
                          <tbody>
                            <tr>
                              ...
                              <td class="smallgrey"><input tabindex="1" class="field" name="login" id="profileid" onkeydown="this.className='field'" onfocus="toggleHint('show', this.name)" onblur="validate_login();" type="text">
                                <!-- HINT STARTS HERE -->
