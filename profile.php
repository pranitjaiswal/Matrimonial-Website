...
$sql = "SELECT * FROM users, user_profile, countries,religion WHERE users.UserID=user_profile.UserID and users.CountryID=countries.CountryID and users.LoginID='".mysql_escape_string($_REQUEST['id'])."' and religion.ReligionID=users.ReligionID";
...
<html>
<head>
<title><?PHP echo $rowsettings['ScriptName']?> - <?PHP echo $row['LoginID'] ?>'s Profile</title>
...
<?PHP
 ...
 include "partnerinteraction.php"
?>
...
<td rowspan="2" height="8" width="10"><spacer type="block" height="8" width="10"></td>
<td height="8" width="167" colspan="2"><spacer type="block" height="8" width="167"></td>
</tr>
...
$sqlstate = "SELECT * FROM user_profile, users, states WHERE users.UserID=user_profile.UserID and users.LoginID='".mysql_escape_string($_REQUEST['id'])."' and user_profile.StateID=states.StateID";
...
<td align="center" height="210" valign="middle" width="160" style="padding:0 0 0 40"><div style="border: 1px solid rgb(192, 192, 192); padding: 5px;">
<?PHP
if($row['photo2'] != "")
{
?>
...
?>
<form method="post" action="profile.php?id=<?PHP echo $_REQUEST['id']?>">
<strong>Write Your Message Here :</strong><br><br>
